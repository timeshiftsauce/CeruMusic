...
function useFetch(url, ...args) {
  ...
  const {
    fetch = (_b = (_a = defaultWindow) == null ? void 0 : _a.fetch) != null
      ? _b
      : globalThis == null
        ? void 0
        : globalThis.fetch,
...
function useFileDialog(options = {}) {
  ...
  const inputRef = computed(() => {
    var _a
    const input =
      (_a = unrefElement(options.input)) != null
        ? _a
        : document2
          ? document2.createElement('input')
          : void 0
    if (input) {
      input.type = 'file'
...
function useScroll(element, options = {}) {
  ...
  if (
    (observe == null ? void 0 : observe.mutation) &&
    element != null &&
    element !== window2 &&
    element !== document
  ) {
...
function usePointerSwipe(target, options = {}) {
  ...
  tryOnMounted(() => {
    ...
    ;(_b = (_a = targetRef.value) == null ? void 0 : _a.style) == null
      ? void 0
      : _b.setProperty('touch-action', 'pan-y')
