...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
        ...
        items: [
          { text: "安装教程", link: "/guide/" },
          {
            ...
            items: [
              ...
              {
                text: "听歌识曲与分享",
                link: "/guide/used/recognize-and-share",
              },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "澜音插件开发文档（重点）",
            link: "/guide/CeruMusicPluginDev",
          },
          { text: "澜音后端对接文档", link: "/guide/api" },
          {
            text: "一起听 · 接口对接（开发者）",
            link: "/guide/listen-together-api",
          },
        ],
      },
      {
    ...
    editLink: {
      pattern:
        "https://github.com/timeshiftsauce/CeruMusic/edit/main/docs/:path",
    },
    search: {
      provider: "local",
    },
