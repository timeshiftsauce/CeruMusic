...
澜音 **2.0 起**使用插件 v2，**1.14.1 仍使用 v1**。在 2.0 的设置 → 插件管理中安装作者提供的单个 `plugin.js`，检查插件信息后点击“使用”或启用。需要网络等能力时，软件会请求对应授权。
...
开发者请阅读 [v2 入门教程](/guide/plugins/v2/quick-start)，版本关系见 [兼容说明](/guide/plugins/v2/compatibility)。
